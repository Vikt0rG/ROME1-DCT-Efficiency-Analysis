...
constexpr double STRIP_WIDTH_CM = 2.5;              // Width of each strip in cm
...
constexpr double TRIGGER_TIME_WINDOW = 400e-9;      // Time window for trigger-based rate calculations (400 ns)
